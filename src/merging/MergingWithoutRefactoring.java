...
//		alignmentsFiles.add("Data/SNOMED2NCI.rdf");
		...
		//manager.saveOntology(mergedOntology, new TurtleOntologyFormat(), IRI.create(new File("Results/MergedOntology_WithoutRefact_Turtle.owl")));
	...
	public static int getMergedNamesForEquivalentEntitiesUsingRepairedAndFilteredAlignments_SoftVersion(String alignmentFile, double threshold, HashMap<String, String> hash1, HashMap<String, HashSet<String>> hash2, int k, HashSet<String> redundantEntities) throws AlignmentException{
	...
	public static int getMergedNamesForEquivalentEntitiesUsingRepairedAndFilteredAlignments_HardVersion(String alignmentFile, double threshold, HashMap<String, String> hash1, HashMap<String, HashSet<String>> hash2, int k, HashSet<String> redundantEntities) throws AlignmentException{
	...
	public static OWLObjectPropertyExpression getObjectPropertyExpressions(OWLObjectPropertyExpression propExpr, OWLDataFactory df, HashMap<String, String> mergedEntitiesNewNames, String iri) {
		...
		//else if (propExpr instanceof OWLObjectInverseOfImpl) {
			...
			owlObjectPropertyRestriction = df.getOWLObjectInverseOf((OWLObjectProperty) getObjectPropertyExpressions(inverseProp, df, mergedEntitiesNewNames, iri));		
		}
	...
	public static void extractAndCreateDifferentIndividualsOfIndividual(OWLNamedIndividual instance, HashMap<String, String> mergedEntitiesNewNames, Set<OWLAxiom> axioms, String iri, OWLDataFactory datafactory, OWLNamedIndividual indiv, OWLOntology ont) {
		...
		Collection<OWLIndividual> differentIndiv = EntitySearcher.getDifferentIndividuals(indiv, ont).collect(Collectors.toSet());
